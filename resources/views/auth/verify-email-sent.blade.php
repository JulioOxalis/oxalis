...
<h5 class="fw-bold text-center mb-2">Verification email sent</h5>
...
@endisset
<div class="text-center mt-4"><a href="{{ route('oxalis.login') }}" class="btn btn-ox-out">Back to sign in</a></div>
@endsection